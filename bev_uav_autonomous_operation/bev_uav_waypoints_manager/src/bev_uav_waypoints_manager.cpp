...
Waypoints_Manager::Waypoints_Manager():nh("~"){
    ...
    pubGoalENUPoint     = nh.advertise<bev_uav_msgs::UAVWaypoint>(ns + paramPubGoalPointOutput, 10);
...
void Waypoints_Manager::pubWaypoint(const mavros_msgs::Waypoint::_frame_type frame, const double x, const double y, const double z){
    ...
    bev_uav_msgs::UAVWaypoint ENUPoint;
...
//            ENUPoint.type = bev_uav_msgs::UAVWaypoint::TYPE_VELOCITY_YAW_FIRST_WP;
            ...
            switch (waypointCommand) {
                ...
                case LOITER:
                    ...
                    ENUPoint.type = bev_uav_msgs::UAVWaypoint::TYPE_LOITER;
                    break;
                default:
