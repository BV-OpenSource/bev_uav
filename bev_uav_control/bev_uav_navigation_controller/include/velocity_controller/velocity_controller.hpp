...
namespace VC{
    class Velocity_Controller
    {
        public:
            ...
            // Variables
            bool setpointRec = false;

           bev_uav_msgs::UAVWaypoint goalPoint;
        ...
        private:
            ...
            double calculateWaypointHeading(geometry_msgs::PoseStamped currPos,bev_uav_msgs::UAVWaypoint goalPos);
